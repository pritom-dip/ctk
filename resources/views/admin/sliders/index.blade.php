...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="{{route('slider.create')}}" class="btn btn-xs btn-success pull-left text-white" title="Add New"><i class="fa fa-plus"></i> <span class="text-capitalize">Add photo</span></a>
        </div>
        @endif
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            ...
                            @if(App\Model\Permission::roleHasSpecificPermission('slider.show'))

                        	<a href="{{route('slider.show', $item->id)}}" class="btn btn-xs btn-success action-view" title="View"><i class="fa fa-eye"></i></a>

                            @endif

                            @if(App\Model\Permission::roleHasSpecificPermission('slider.edit'))

                        	<a href="{{route('slider.edit', $item->id)}}" class="btn btn-xs btn-primary action-pencil" title="Edit"><i class="fa fa-pencil"></i></a>

                            @endif

                            @if(App\Model\Permission::roleHasSpecificPermission('slider.destroy'))

                        	<form action="{{route('slider.destroy', $item->id)}}" method="POST" class="d-inline-block">
    						    @csrf
    						    @method('DELETE')
