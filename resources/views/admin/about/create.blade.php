...
<div class="box box-success">
    ...
    <div class="box-header with-border">
        <div class="box-header pull-left">
            <span class="box-title">Create About</span>
        </div>
    ...
    <div class="box-body box-min-height">
        <div class="row">
            <form class="form-row col-md-12" method="POST" action="{{route('about.store')}}">
                @csrf
                    ...
                    <div class="row p-2 pb-4">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <textarea id="ck-editor" name="description" class="form-control"></textarea> 
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-11">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="description" placeholder="Description" class="form-control form-control-sm" id="inputRole" />
                                                    </div>
                                                </div>
