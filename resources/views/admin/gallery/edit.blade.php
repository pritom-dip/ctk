...
@section('title', 'Update gallery Image')
...
<div class="box box-success">
    ...
    <div class="box-body box-min-height">
        <div class="row">
            <form class="form-row col-md-8" method="POST" action="{{route('gallery.update',$gallery -> id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-12 pt-4">
                    <div class="row">
                        <div class="col-md-4">
                            <label  for="pro_pic"><img id="up_44" width="200px" height="200px" style="cursor: pointer; border: 2px solid #3C8DBC; padding: 4px;" src="{{ asset('storage/'. $gallery -> image)}}"  alt=""></label>
