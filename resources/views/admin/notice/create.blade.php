...
<div class="box box-success">
    ...
    <div class="box-body box-min-height">
        <div class="row">
            <form class="form-row col-md-12" method="POST" action="{{route('notice.store')}}">
                @csrf
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="inputRole">Name</label>
                        <input type="text" name="notice[name]" placeholder="Description" class="form-control form-control-sm" id="inputRole" />
                    </div>
                </div>
                <div class="col-md-11">
                    <div class="form-group">
                        <label for="inputRole">Short Description</label>
                        <input type="text" name="notice[short_desc]" placeholder="Description" class="form-control form-control-sm" id="inputRole" />
                    </div>
                </div>
                    ...
                    <div class="row p-2 pb-4">
                        ...
                        <div class="col-3" style="margin-left: 20px">
                            <div class="form-group">
                                ...
                                <textarea id="ck-editor" name="notice[long_desc]" class="form-control"></textarea>
                            </div>
                        </div>
                ...
                <!-------------- button -------------->
                <div class="col-12 mb-3 mt-4" style="margin-left: 20px">
